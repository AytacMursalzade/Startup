        ...
        <Link>
          <div className="bullet w-[660px] h-[300px] ml-[75px]">
            <div className="flex flex-col gap-[20px] mt-[77px] ml-[53px]  ">
              ...
              <div>
                <button className=" border-1 border-black-100 hover:bg-white hover:text-[#2695FF] text-white font-semibold rounded-[45px] border border-solid-1  px-[20px] py-[6px] ">
                  VIEW MORE
                </button>
              </div>
            </div>
