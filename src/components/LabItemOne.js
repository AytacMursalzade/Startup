...
function LabItemOne() {
  ...
  return (
    <div>
      <ul className="LabOne flex justify-around px-[75px] mt-[100px]">
                {data.map((item) => {
                    const LabitemImg = {
                    ...
                    return (
                        <li key={item.id} className="LabOne1">
                            <div className="flex ">
                                <div style={LabitemImg} className="LabOne2 w-[436px]  h-[232px] flex flex-col justify-center gap-[15px] pl-[200px]">
