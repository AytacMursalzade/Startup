...
import FtTop1 from "../assets/bookImg1.jpg";
import FtTop2 from "../assets/BookImg2.jpg";
import FtTop3 from "../assets/BookImg3.jpg";
    ...
    <div className="mt-[30px] px-[75px] ">
         <div className="flex flex-col items-center justify-center mt-[126px]">
          ...
          <div className="flex items-center justify-center mt-[15px]">
            ...
            <span
              className="font-bold text-[#F27928] text-[27px]"
            >
              <FaGavel />
            </span>
      ...
      <ul className="flex flex-row gap-[15px] mt-[15px] justify-around latestnew ">
        {data.map((item,index) =>(
            ...
            <div className="symbolsLatest flex flex-col ">
              <Link>
                <h1 className=" text-[20px] hover:text-[#F27928] font-bold">
                  {item.description}
