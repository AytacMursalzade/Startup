...
function LatesAnti() {
  ...
  return (
    <>
      <div className="topic flex flex-col items-center justify-center mt-[126px] mb-[75px]">
      ...
      <div className="flex gap-[13px] px-[71px]">
        {data.map((item, index) => (
          <div
            key={index}
            style={{
          ...
          >
            <div className="flex w-[322px] h-[400px] flex-col">
              ...
              <div className="shadow-lg "><div className="phoneBottom  h-[120px] bg-[white] flex flex-col border-t-2 mt-[240px] justify-center items-center gap-[9px]">
                <Link to="/">
