    ...
    return allCat
      ...
      .map((item) => (
        ...
        >
          ...
          <Link to="/"><h3 className="nft-item-title text-[#484848] hover:text-[#F27928] text-[24px] font-bold ">{item.description}</h3></Link>
          <p className="nft-item-price text-[16px] text-[#F27928] font-bold ">{item.price}</p>
          <Link to="/"><button className="nft-item-button bg-[#F27928] font-bold text-[12px] text-white rounded-[30px] w-[160px] h-[47px] "><p>{item.paragraph}<br/>{item.paragraph1}</p></button></Link>
        </div>
      ));
  };
    ...
    <div className="nft-filter-container flex w-[100%] mt-[100px] mb-[100px] gap-9 ">
      ...
      <div className={`nft-items-container flex-1 ${showFilters ? "pl-4" : ""}`}>
        ...
        <div className="filter-buttons-container h-[50px] w-[100%] pl-[25%] bg-[white] shadow-2xl text-[#666666] flex items-center justify-around buttons mb-4 text-[14px] font-bold ">
          <button onClick={() => setActiveCat("all")} className="filter-button mr-2 cursor hover:text-[#F27928] ">All</button>
          <button onClick={() => filterGroup("ART")} className="filter-button mr-2 cursor hover:text-[#F27928] ">ART</button>
          <button onClick={() => filterGroup("DOMAINS")} className="filter-button mr-2 cursor hover:text-[#F27928] ">DOMAINS</button>
          <button onClick={() => filterGroup("SPORTS")} className="filter-button mr-2 cursor hover:text-[#F27928] ">SPORTS</button>
          <button onClick={() => filterGroup("TRADING CARDS")} className="filter-button mr-2 cursor hover:text-[#F27928] ">TRADING CARDS</button>
          <button onClick={() => filterGroup("UTILITY")} className="filter-button mr-2 cursor hover:text-[#F27928] ">UTILITY</button>
          <button onClick={() => filterGroup("VIRTUAL WORLDS")} className="filter-button mr-2 cursor hover:text-[#F27928] ">VIRTUAL WORLDS</button>
        </div>
