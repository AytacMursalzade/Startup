...
function CountClock() {
  return (
    <div className="container flex justify-around mt-[200px] mb-[200px] ">
      <div>
      ...
      <div className="flex flex-col gap-[30px] ">
        ...
        <div className="flex gap-[16px]  items-center ">
          <button className="bg-[#EA3546] hover:bg-[white] hover:text-[#EA3546] px-[18px] py-[10px] rounded-[45px] font-semibold text-[white] ">PLACE BID</button>
