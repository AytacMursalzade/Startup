...
import FtTop1 from "../assets/Ftop1.jpg";
import FtTop2 from "../assets/Ftop2.jpg";
import FtTop3 from "../assets/Ftop3.jpg";
import { FaGavel } from "react-icons/fa";

function SelfFooter({hoverColor}) {

  const data = [
    {
        id:1,
        img:FtTop1,
        description:"How to Move Out of a",
        description1:"Storage Unit",
    ...
    },
    {
        id:2,
        img:FtTop2,
        description:"Organize a Storage Unit",
        description1:"Like a Pro",
        paragraph:"Bring to the table win-win survival",
        paragraph1:"strategies to ensure…",
    },
    {
        id:3,
        img:FtTop3,
        description:"Here's How Vehicle",
        description1:"Storage Works",
        paragraph:"Bring to the table win-win survival",
        paragraph1:"strategies to ensure…",
    },
  ]
    ...
    <div className="mt-[30px] px-[75px] ">
         <div className="flex flex-col items-center justify-center mt-[126px]">
          ...
          <div className="flex items-center justify-center mt-[15px]">
            ...
            <span
              className="font-bold text-[#414144] text-[27px]"
            >
              <FaGavel />
            </span>
      ...
      <ul className="flex flex-row gap-[15px] mt-[15px] justify-around latestnew ">
        {data.map((item,index) =>(
