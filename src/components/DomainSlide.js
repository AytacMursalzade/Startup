...
function DomainSlide({ DomainImgSlide }) {
  ...
  return (
    <div style={DomainSlide} className="domainSlide relative w-[92%] h-[550px] mt-[28px] mx-[62px] ">
      <div className="domainYellow absolute right-20 bottom-[198px] w-[350px] h-[380px] bg-[#FFE347] pt-[60px] pl-[45px] flex flex-col gap-[8px]  ">
      ...
      <div className="h-[272px] flex flex-col gap-[5px] ml-[50px] ">
        ...
        <button className="domainBtn w-[180px] h-[60px] bg-[#18AE91] hover:bg-[white] hover:text-[#606060] text-[white] font-bold ">
          VIEW DOMAIN
        </button>
      </div>
    </div>
