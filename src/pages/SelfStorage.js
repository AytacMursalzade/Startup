...
function SelfStorage() {
  return (
    <div className="container">
      ...
      <StoragePoster />
      <SalesAntiques imagePoster={imgSelf} hoveredSales="colorBluishBlack" hoverBGsales="colorBluishBlackbg" imgPoster={imagePosterself} SalesText="Storage 4 Less" img={imageSelf} toolBg="#414144" textPosterCard="HOUSEHOLD" productCard="Collections" numberProduct="4" productName="Storages" posterCard="SILVER" numberPoster="4"/>
      <Locationn radiusBorder="9px" img={locationimageSelf} GavellColor="#414144" inputBg="#414144"/>
      <FooterTop hoverColor="colorBluishBlack" LatText1="How to Move Out of a" LatestText2="Storage Unit" LatestTextp1="Bring to the table win-win survival" LatestTextp2="Strategies to ensure…" GavelColor="#414144" />
      <FooterAverage GavelColorshop="#414144" nameAuction="LATEST NEWS" />
      <FooterFilter rounded="9px"  bgColor="#414144"/>
      <Footer textH1="#343E47" textColorFB="#343E47" hoverFB="colorBluishBlack" hoverbgF="colorBluishBlackbg" Logoimage={LogoimageStorage}/>
    </div>
  );
}
