...
function Coins() {
  return (
    <div>
      ...
      <PosterCoins />
      <SalesAntiques display5={true} imagePoster={imgMil} hoveredSales="colorshipsHarbour" hoverBGsales="colorshipsHarbourbg" imgPoster={imagePosterCoin} SalesText="Roman & Byzantine Coin" img={imageMil} toolBg="#4F89B0" textPosterCard="ANCIENT" productCard="Collections" numberProduct="5" productName="Collections" posterCard="SILVER" numberPoster="4"/>
      <Locationn radiusBorder="9px" img={locationimageCoins} GavellColor="#4F89B0" inputBg="#4F89B0"/>
      <FooterTop display={false} hoverColor="colorshipsHarbour" LatText1="A Phone keeps Your" LatestText2="Friends away" LatestTextp1="Bring to the table win-win survival" LatestTextp2="Strategies to ensure…" GavelColor="#4F89B0" />
      <FooterAverage GavelColorshop="#4F89B0" nameAuction="SHOP BY BRAND" />
      <FooterFilter  mtfooteR="75px" rounded="9px"  bgColor="#4F89B0"/>
      <Footer ptFtr="50px" BtnRadius="9px" lastftrM="70px" textH1="#343E47" hoverFB="colorshipsHarbour" textColorFB="#343E47" hoverbgF="colorshipsHarbourbg" Logoimage={LogoimageCoins}/>
    </div>
  )
}
