...
import MediaThree from "../components/MediaThree";
import ShopTopBlog from "../components/ShopTopBlog";

function MediaThreeColApp() {
  return (
    <div className="container">
      <HeaderArrage basketColor="#0543EC" Logoimage={Logoimage1} />
      <Header bgColor="#2695FF" /> 
      <ShopTopBlog display2={true} title="Media" paragraph="3 columns" description="3 columns"/>
      <MediaThree />
...
export default MediaThreeColApp
