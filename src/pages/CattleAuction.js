...
function CattleAuction() {
  return (
    <div className="container">
      ...
      <LatestAuto OneLatest="LATEST AUCTIONS" toolRadius="50%" textLatest="Herd Bull Punch P007" art={art} GavelTextColor="#627452" tooltipBg="#627452" howToused="Current Bid" />
      <CattlePoster /> 
      <SalesCattle SalesText="Old English Game Lod #788"/>
      <Locationn img={locationimageCat} GavellColor="#627452" inputBg="#627452"/>
      <FooterTop LatText1="How rotational grazing" LatestText2="helps in a drought" LatestTextp1="Bring to the table win-win survival" LatestTextp2="Strategies to..."  GavelColor="#627452" />
